...
void train1 (void const *argument)
{
  ...
  while (1)
    ...
    //code pour gérer le fonctionnement du train 1
		...
		//exemple adapté pour un RTOS
		//méthode MAE
		switch (etat1){
			
			case 0: //train arrêté: attente d'appui sur M1 et train en A1
							Arret_train1() ;
							osSignalWait(0x01,osWaitForever);		// sommeil attente M1
							osSignalClear(tid_train1,0xFFFF);
							etat1 = 1;
							break;
							
			case 1: //train avance: attente arrivée en B1
							Avance_train1() ;
							osSignalWait(0x02,osWaitForever);		// sommeil attente B1
							osSignalClear(tid_train1,0xFFFF);
							etat1 = 2;
							break;				
			...
			case 2: //train recule: attente arrivée en A1
							Recule_train1() ;
							osSignalWait(0x04,osWaitForever);		// sommeil attente A1
							osSignalClear(tid_train1,0xFFFF);
							etat1 = 3;
							break;			
			
			case 3: //train avance: attente arrivée en Sg 1-4
							Avance_train1() ;
							osSignalWait(0x08,osWaitForever);		// sommeil attente Sg 1-4 (pb capteur C1)
							osSignalClear(tid_train1,0xFFFF);
							etat1 = 4;
							break;	
